      ...
      <div className="container">
        <div className="text-center mb-12">
            ...
            <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
                At CowKind Haven, we are dedicated to the principle of 'Gau Seva' – serving the cow, who is revered as a mother in our culture. We believe every cow deserves to live a life free from suffering and filled with care.
            </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
                ...
                CowKind Haven is more than just a shelter; it's a home. We rescue cows from neglect and abandonment, providing them with nutritious food, clean water, medical attention, and a peaceful environment where they can thrive. Our commitment extends for their entire lifetime, ensuring they are always treated with the dignity and love they deserve.
                </p>
